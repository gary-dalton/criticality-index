---
title: “Order (O): the Ordering Force”
linkTitle: “Order Component”
description: “Theory, indicator selection, and implementation contract for the Order (damping/dissipation) component of the SOC governance model”
author: “Gary Dalton”
...
draft: true
weight: 40
keywords: “order, damping, dissipation, political stability, rule of law, governance, SOC model component”
---

# Order (O): the Ordering Force

The Order component measures the damping and dissipation forces in a governance system — the mechanisms that constrain excitation, enforce norms, and prevent runaway cascades. In the SOC sandpile analogy, Order is the slope limit that causes grains to topple and energy to exit the system at the boundary. This document covers both the theoretical rationale for indicator selection and the implementation contract for the Julia functions.

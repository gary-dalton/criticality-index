---
title: "Grounding the Criticality Hypothesis"
linkTitle: "Grounding Layer"
description: "Five independent empirical diagnostics that test whether governance time series exhibit signatures consistent with Self-Organized Criticality"
author: "Gary Dalton"
...
draft: true
weight: 30
keywords: "criticality hypothesis, empirical signatures, power law, correlation divergence, scale invariance, fractal structure, governance validation"
---

# Grounding the Criticality Hypothesis (CH)

This document defines five independent empirical diagnostics — power-law event distributions, diverging correlation lengths, scale invariance, fractal structure, and absence of characteristic scale — that test whether a country-year time series exhibits signatures consistent with Self-Organized Criticality. These diagnostics are structurally independent from the model's index components, preventing circular validation.

...
| 01.03 | **Manna + overtopping** — threshold-elevation baseline (Model B), structural-integrity damage (Model C); locates absorbing barrier in (T, α, recovery_rate) phase space | [`validation/01_03_manna_overtopping.md`](validation/01_03_manna_overtopping.md) | — | Designed |
| 01.04 | **Negative controls** — validation by counter-example. Rejection tests on Poisson, bulk-dissipation subcritical, and excess-distribution supercritical on both BTW and Manna substrates. Builds rejection matrix for signature discrimination. | [`validation/01_04_negatives.md`](validation/01_04_negatives.md) | — | Designed |

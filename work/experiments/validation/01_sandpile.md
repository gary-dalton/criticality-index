...
**Experiment 01.03: Manna + overtopping** — see [`01_03_manna_overtopping.md`](01_03_manna_overtopping.md). Builds on plain Manna to concretely test the abstract-CSOC baseline (Model B: threshold elevation only, corner case of the overtopping simulator) and the full overtopping mechanism (Model C: threshold elevation + σ field + damage/recovery dynamics). Primary deliverable: phase-space map locating the absorbing barrier. See also [`../ideas/overtopping.md`](../ideas/overtopping.md) for the mechanism framework.
